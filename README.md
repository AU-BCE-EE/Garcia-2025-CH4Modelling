...
## `Batch 1`
Contains data on CH4 emissions, CH4 concentration, room temperature, and relative humidity from the first batch. Additionaly, a subfolder `CH4 rate` with data on the slurry incubation to determine the CH4 rate.  
## `Batch 2`
Contains data on CH4 emissions, CH4 concentration, room temperature, and relative humidity from the second batch. Additionaly, a subfolder `CH4 rate` with data on the slurry incubation to determine the CH4 rate.  
## `Batch 3`
Contains data on CH4 emissions, CH4 concentration, room temperature, and relative humidity from the third batch. Additionaly, a subfolder `CH4 rate` with data on the slurry incubation to determine the CH4 rate.
## `Batch 4`
