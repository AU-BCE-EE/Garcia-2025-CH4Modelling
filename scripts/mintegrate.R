...
setwd("O:/Tech_BCE/Environmental Engineering/Air Quality Engineering/Pablo García/Courses/Online analytical chemistry/OAC-course-main/OAC-course-main/functions-R")
save(mintegrate,file="mintegrate.RData")